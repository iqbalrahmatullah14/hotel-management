        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-200">
                    {{-- TODO Tugas D: Ganti static rows dengan @foreach ($bookings as $booking) --}}
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 font-medium">Rp 1.221.000</td>
                        <td class="px-6 py-3">
                            <span
                                class="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-700">Confirmed</span>
                        </td>
                        <td class="px-6 py-3">
                            {{-- TODO Tugas D: Ganti route('bookings.show', 1) → route('bookings.show', $booking) --}}
                            <a href="{{ route('bookings.show', 1) }}" class="text-blue-600 hover:text-blue-800 p-1" title="Detail">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-3 font-medium">Rp 3.996.000</td>
                        <td class="px-6 py-3">
                            <span class="px-2 py-1 text-xs font-medium rounded-full bg-emerald-100 text-emerald-700">Checked
                                In</span>
                        </td>
                        <td class="px-6 py-3">
                            <a href="{{ route('bookings.show', 2) }}" class="text-blue-600 hover:text-blue-800 p-1" title="Detail">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
